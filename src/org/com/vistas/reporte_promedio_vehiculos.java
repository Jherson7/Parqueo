 ...
 * @author Jherson
 */
public class reporte_promedio_vehiculos extends javax.swing.JInternalFrame {
    JXDatePicker picker;
    /**
     * Creates new form reporte_fecha_hora
     */
    public reporte_promedio_vehiculos() {
        initComponents();
        tabla_reporte.setModel(reportes_controller.get_estadistica_vehiculos(date_inicio.getDate(),date_fin.getDate()));
       // initCalendar();
    }
    ...
    private void btn_exportarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_exportarActionPerformed
        ...
        manejador_de_reportes.reporte_por_fecha_hora(picker.getDate());
